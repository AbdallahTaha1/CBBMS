        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BloodBanks_AspNetUsers_BloodBankId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hospitals_AspNetUsers_HospitalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BloodBankId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BloodStockUnits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BloodStockUnits_BloodBanks_BloodBankId",
                        column: x => x.BloodBankId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    VirusTestResult = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BloodType = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    PatientStatus = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HospitalRequests_Hospitals_HospitalId",
                        column: x => x.HospitalId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BloodStockUnits_BloodBankId",
                table: "BloodStockUnits",
                column: "BloodBankId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HospitalRequests_HospitalId",
